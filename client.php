...
<div id="entete">
    ...
    <a href="formateur.php"> <input type="button" value="Formateur" class = "btnbtn-secondary"> </a>
    <a href="fournisseur.php"> <input type="button" value="Fournisseur" class = "btnbtn-secondary"> </a>
    <a href="client.php"> <input type="button" value="Client" class = "btnbtn-secondary"> </a>
